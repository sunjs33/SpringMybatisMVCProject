...
public class GoodsCartController {
	...
	public String goodsCartAdd(@RequestParam(value = "goodsNum")String goodsNum, Model model, HttpSession session) {
	...
	public String goodsWishAdd(@RequestParam(value = "goodsNum") String goodsNum, HttpSession session, Model model) {
