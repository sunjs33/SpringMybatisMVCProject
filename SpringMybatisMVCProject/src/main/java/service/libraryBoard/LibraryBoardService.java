...
public class LibraryBoardService {
	...
	public void WritePro(LibraryCommand libraryCommand, HttpServletRequest request) {
		...
		dto.setBoardPass(bCryptPasswordEncoder.encode(libraryCommand.getBoardPass()));
		...
		for (MultipartFile	mf : libraryCommand.getReport()) {
			...
			String originalFileExtension=original.substring(original.lastIndexOf(".")); //확장자 가져오기
